...
@dataclass
class BaseMTLLoraRuntimeConfig:
    """
...
@dataclass
class BaseMTLLoraConfig(PeftConfig):
    """
    ...
    task_num: int = field(default=1, metadata={"help": "task_num"})
    ...
    loftq_config: Union[BaseMTLLoraLoftQConfig, dict] = field(
        default_factory=dict,
        metadata={
            "help": (
    ...
    runtime_config: BaseMTLLoraRuntimeConfig = field(
        default_factory=BaseMTLLoraRuntimeConfig, metadata={"help": "Runtime configurations"}
    )
    ...
    def __post_init__(self):
        super().__post_init__()
        self.peft_type = PeftType.BASEMTLLORA
        self.target_modules = (
