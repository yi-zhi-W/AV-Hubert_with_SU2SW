...
@dataclass
class MTLLoraConfig(PeftConfig):
    """
    This is the configuration class to store the configuration of a [`MTLLoraModel`].
    ...
    loftq_config: Union[MTLLoftQConfig, dict] = field(
        default_factory=dict,
        metadata={
            "help": (
    ...
    runtime_config: MTLLoraRuntimeConfig = field(
        default_factory=MTLLoraRuntimeConfig, metadata={"help": "Runtime configurations"}
    )
