...
class HYDRALoraConfig(PeftConfig):
    ...
    loftq_config: Union[HYDRALoraLoftQConfig, dict] = field(
        default_factory=dict,
        metadata={
            "help": (
    ...
    runtime_config: HYDRALoraRuntimeConfig = field(
        default_factory=HYDRALoraRuntimeConfig, metadata={"help": "Runtime configurations"}
    )
