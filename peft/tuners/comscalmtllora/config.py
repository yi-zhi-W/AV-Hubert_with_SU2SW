...
@dataclass
class COMSCALMTLLoraRuntimeConfig:
    """
...
@dataclass
class COMSCALMTLLoraLoftQConfig:
    """
...
@dataclass
class COMSCALMTLLoraConfig(PeftConfig):
    """
    This is the configuration class to store the configuration of a [`COMSCALMTLLoraModel`].
    ...
    loftq_config: Union[COMSCALMTLLoraLoftQConfig, dict] = field(
        default_factory=dict,
        metadata={
            "help": (
    ...
    runtime_config: COMSCALMTLLoraRuntimeConfig = field(
        default_factory=COMSCALMTLLoraRuntimeConfig, metadata={"help": "Runtime configurations"}
    )
    ...
    def __post_init__(self):
        super().__post_init__()
        self.peft_type = PeftType.COMSCALMTLLORA
        self.target_modules = (
