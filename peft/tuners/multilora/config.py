...
class MULTILoraConfig(PeftConfig):
    ...
    loftq_config: Union[MULTILoraLoftQConfig, dict] = field(
        default_factory=dict,
        metadata={
            "help": (
    ...
    runtime_config: MULTILoraRuntimeConfig = field(
        default_factory=MULTILoraRuntimeConfig, metadata={"help": "Runtime configurations"}
    )
