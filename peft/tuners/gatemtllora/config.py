...
@dataclass
class GATEMTLLoraRuntimeConfig:
    """
...
@dataclass
class GATEMTLLoraConfig(PeftConfig):
    """
    This is the configuration class to store the configuration of a [`GATEMTLLoraModel`].
    ...
    loftq_config: Union[GATEMTLLoftQConfig, dict] = field(
        default_factory=dict,
        metadata={
            "help": (
    ...
    runtime_config: GATEMTLLoraRuntimeConfig = field(
        default_factory=GATEMTLLoraRuntimeConfig, metadata={"help": "Runtime configurations"}
    )
    ...
    def __post_init__(self):
        super().__post_init__()
        self.peft_type = PeftType.GATEMTLLORA
        self.target_modules = (
