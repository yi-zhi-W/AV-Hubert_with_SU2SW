...
@dataclass
class COMBINEDMTLLoraRuntimeConfig:
    """
...
@dataclass
class COMBINEDMTLLoraConfig(PeftConfig):
    """
    This is the configuration class to store the configuration of a [`COMBINEDMTLLoraModel`].
    ...
    loftq_config: Union[COMBINEDMTLLoftQConfig, dict] = field(
        default_factory=dict,
        metadata={
            "help": (
    ...
    runtime_config: COMBINEDMTLLoraRuntimeConfig = field(
        default_factory=COMBINEDMTLLoraRuntimeConfig, metadata={"help": "Runtime configurations"}
    )
    ...
    def __post_init__(self):
        super().__post_init__()
        self.peft_type = PeftType.COMBINEDMTLLORA
        self.target_modules = (
