...
# 定义要评估的适配器路径数组
adapters=(
    "/home/wyz/projects/LLaMA-Factory/saves/qwen2_audio_instruct-7b/gatemtllora_5L_no_shared_no_lambda_1ep"  # path1
    # "/home/wyz/projects/LLaMA-Factory/saves/qwen2_audio_instruct-7b/lora_5L_1ep"  # path2
    # "/home/wyz/projects/LLaMA-Factory/saves/qwen2_audio_instruct-7b/gatemtllora_5L_no_lora_B_w_no_lambda_1ep"  # path3
)
...
# 定义要评估的数据集列表
datasets=("tr_test_full_id_11000" "tr_dev_10000")
...
for i in "${!adapters[@]}"; do
    ...
    for dataset in "${datasets[@]}"; do
        ...
        output_dir="./saves/qwen2audio-7B-Instruct/${adapter_name}_${finetuning_type}_${dataset}"
