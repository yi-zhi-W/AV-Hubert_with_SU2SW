...
# 定义要评估的适配器路径数组
adapters=(
    "/home/wyz/projects/LLaMA-Factory/saves/dpo/dpo_1224_dpo_ug_cer>005_3epoch_128batch/checkpoint-500"  # path1
    # "/home/wyz/projects/LLaMA-Factory/saves/dpo/dpo_0109_dpo_ug_cer>010_"  # path2
...
for i in "${!adapters[@]}"; do
    ...
    for dataset in "${datasets[@]}"; do
        ...
        output_dir="./saves/dpo_results/${adapter_name}_${finetuning_type}_${dataset}_do_sample"
