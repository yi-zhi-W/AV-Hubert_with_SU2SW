...
# 定义要评估的适配器路径数组
adapters=(
    # "/home/wyz/projects/LLaMA-Factory/saves/underwater/mtllora_underwater_QA_train"  # path1
    # "/home/wyz/projects/LLaMA-Factory/saves/underwater/lora_3ep"  # path2
    "/nfs4/wyz/merged_qwen2audio/lora_5l_merged"  # path3
)
# 定义要评估的适配器路径数组
# 定义对应的微调类型数组
finetuning_types=(
...
# datasets=("az_train_id" "tk_train_id" "ky_train_id")
# datasets=("ug_test_id" "tr_test_id")
# datasets=("tk_test_id")
...
for i in "${!adapters[@]}"; do
    ...
    for dataset in "${datasets[@]}"; do
        ...
        output_dir="./saves/lora_5l_merged/${adapter_name}_${finetuning_type}_${dataset}_do_sample"
