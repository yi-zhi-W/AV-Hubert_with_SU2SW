...
def _verify_model_args(
    ...
    if model_args.adapter_name_or_path is not None:
        if finetuning_args.finetuning_type != "lora" and finetuning_args.finetuning_type != "mtllora" and finetuning_args.finetuning_type != "basemtllora" and finetuning_args.finetuning_type != "combinedmtllora" and finetuning_args.finetuning_type != "comscalmtllora"  and finetuning_args.finetuning_type != "gatemtllora" and finetuning_args.finetuning_type != "combroutemtllora"  and finetuning_args.finetuning_type != "multilora" and finetuning_args.finetuning_type != "hydralora":
