...
class FinetuningArguments(
    ...
    finetuning_type: Literal["lora", "freeze", "full", "mtllora", "basemtllora", "multilora", "combinedmtllora", "comscalmtllora", "gatemtllora", "combroutemtllora", "hydralora"] = field(
        default="lora",
    ...
    def __post_init__(self):
        ...
        assert self.finetuning_type in ["lora", "mtllora", "basemtllora", "multilora", "combinedmtllora", "comscalmtllora", "gatemtllora", "combroutemtllora", "hydralora", "freeze", "full"], "Invalid fine-tuning method."
