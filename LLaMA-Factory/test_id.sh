...
# 定义要评估的适配器路径数组
adapters=(
    "/home/wyz/projects/LLaMA-Factory/saves/qwen2_audio_instruct-7b/gatemtllora_mtl_5_Bnum_5_languageid_other_prompt"  # path1
...
# 定义要评估的数据集列表
# datasets=("test_merged_languageid_Identify")
datasets=("language_id")
# 获取当前时间戳用于日志记录
...
for i in "${!adapters[@]}"; do
    ...
    for dataset in "${datasets[@]}"; do
        ...
        output_dir="./saves/results/${adapter_name}_${finetuning_type}_${dataset}"
