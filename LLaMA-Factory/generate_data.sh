...
# 定义要评估的适配器路径数组
adapters=(
    "/home/wyz/projects/LLaMA-Factory/saves/qwen2_audio_instruct-7b/lora_5L_1ep"  # path1
    # "/home/wyz/projects/LLaMA-Factory/saves/qwen2_audio_instruct-7b/MASlora_5L_1ep_"  # path2
