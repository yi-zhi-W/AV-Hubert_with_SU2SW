...
# 定义要评估的适配器路径数组
adapters=(
    "/home/wyz/projects/LLaMA-Factory/saves/underwater_0307/rank_4_caption_train_V2"  # path1
    # "/home/wyz/projects/LLaMA-Factory/saves/qwen2_audio_instruct-7b/lora_5L_2ep"  # path2
    # "/home/wyz/projects/LLaMA-Factory/saves/qwen2_audio_instruct-7b/lora_5L_3ep"  # path3
)
...
# 定义要评估的数据集列表
# datasets=("qa_test_dataset" "caption_test")
datasets=("qa_test_dataset_caption_V2")
# datasets=("tr_test_id")
...
for i in "${!adapters[@]}"; do
    ...
    for dataset in "${datasets[@]}"; do
        ...
        output_dir="./saves/underwater_results/${adapter_name}_${finetuning_type}_${dataset}"
        ...
        llamafactory-cli train \
            --stage sft \
            --do_predict \
            --model_name_or_path "/home/wyz/.cache/huggingface/hub/models--Qwen--Qwen2-Audio-7B-Instruct/snapshots/0a095220c30b7b31434169c3086508ef3ea5bf0a" \
