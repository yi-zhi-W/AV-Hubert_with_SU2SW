...
from src.su2sw_dataset import SU2SWDataset
...
@register_task("su2sw_pretraining", dataclass=AVHubertPretrainingConfig)
class SU2SWPretrainingTask(AVHubertPretrainingTask):
    def load_dataset(self, split: str, **kwargs) -> None:
        ...
        self.datasets[split] = SU2SWDataset(
            manifest,
