...
class Qwen2AudioForConditionalGeneration(Qwen2AudioPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```"""
        # print("Qwen2AudioForConditionalGeneration.forward()")
        ...
        if inputs_embeds is None:
            ...
            if input_features is not None and input_ids.shape[1] != 1:
                ...
                audio_outputs = self.audio_tower(input_features, attention_mask=audio_attention_mask, language_id = language_id)
